...
class JS(BasicJumpInstruction):
    ...
    def condition(self, cpu: Processor) -> bool:
        return cpu.flag_negative


class JNS(BasicJumpInstruction):
    """
    jns label
    """
    ...
    def condition(self, cpu: Processor) -> bool:
        return not cpu.flag_negative


class JC(BasicJumpInstruction):
    """
    jc label
    """
...
class JNC(BasicJumpInstruction):
    """
    jnc label
    """
