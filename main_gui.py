...
if __name__ == "__main__":
    ...
    main_memory = MainMemory(config_data["main_memory_size"], [keyboard_perf, screen_perf], [Int16(config_data["keyboard_address"]), Int16(config_data["screen_address"])], Int16(config_data["stack_address"]))
